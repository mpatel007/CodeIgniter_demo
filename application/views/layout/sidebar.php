     ...
     <div class="user-panel mt-3 pb-3 mb-3 d-flex">
       <div class="image">
         <?php
          ...
          ?>
         <img src="<?php echo base_url('uploads/'.$userdata->image .'');?>" width="auto" alt="User Image">
       </div>
       <div class="info">
         <a href="#" class="d-block text-sm">Welcome..<br><?php echo $userdata->name;?></a>
       </div>
     </div> 
     <!-- Sidebar Menu -->
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="<?php echo base_url(); ?>index.php/dashbord/usertheme" class="nav-link">
