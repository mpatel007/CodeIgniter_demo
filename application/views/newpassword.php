...
<body>
    <div class="signup-form">
        <form onsubmit="return false" method="post" name="newpassword" enctype="multipart/form-data" id="newpassword">
            ...
            <div class="form-group">
                <button type="submit" id="newpassword" name="newpassword" class="btn btn-primary btn-lg">Submit</button>
            </div>
        </form>
