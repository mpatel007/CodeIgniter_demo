...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 22, 2021 at 05:14 AM
...
CREATE TABLE IF NOT EXISTS `demo` (
  `id` int(11) NOT NULL,
  `demo1` int(5) NOT NULL,
  `demo2` int(5) NOT NULL
...
INSERT INTO `demo` (`id`, `demo1`, `demo2`) VALUES
(5, 55, 5);

-- --------------------------------------------------------

--
-- Table structure for table `dup_demo`
--

DROP TABLE IF EXISTS `dup_demo`;
CREATE TABLE IF NOT EXISTS `dup_demo` (
  `demo1` int(5) NOT NULL,
  `demo2` int(5) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `dup_demo`
--

INSERT INTO `dup_demo` (`demo1`, `demo2`) VALUES
(55, 5);
...
INSERT INTO `user` (`id`, `name`, `contact`, `email`, `password`, `gender`, `country`, `state`, `city`, `image`, `status`, `created_at`, `updated_at`, `tokens`) VALUES
(1, 'Mohit Patel', '9079023295', 'rupalamohit1176@gmail.com', '25f9e794323b453885f5181f1b624d0b', 'male', 101, 12, 1023, '540c1ba119656a1c25435a704d84285a.png', 1, '2021-03-16 17:56:48', '2021-03-16 17:56:48', 'z2ZNyPXxYu1nF3mg'),
(3, 'CHIRAG SONI', '1236547895', 'chiragsonim55@gmail.com', '25f9e794323b453885f5181f1b624d0b', 'male', 101, 33, 420, '194db86a462162ff8b89019d800689c7.jpg', 1, '2021-03-16 17:59:54', '2021-03-16 17:59:54', ''),
(4, 'sunny patell', '1234567890', 'margipatel73@gmail.com', 'e807f1fcf82d132f9bb018ca6738a19f', 'male', 101, 12, 1019, '9daad9aa16b0a0ec7a8a2d453a6a675e.jpg', 1, '2021-03-16 18:11:00', '2021-03-16 18:11:00', ''),
(5, 'nikul', '1234567890', 'sa@gmail.com', 'e88bdd422fd26a0f5263807fab704991', 'male', 101, 12, 952, '3c98b475810f0afde91995fdef3c7c07.jpg', 0, '2021-03-16 18:16:25', '2021-03-16 18:16:25', '');
COMMIT;
